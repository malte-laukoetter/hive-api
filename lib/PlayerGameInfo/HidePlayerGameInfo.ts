...
export class HidePlayerGameInfo extends PlayerGameInfo implements PlayerGameInfoAchievements{
    constructor(points: number, readonly firstLogin: Date, readonly lastLogin: Date, readonly gamesPlayed: number,
                readonly victories: number, readonly deaths: number, readonly hiderKills: number,
...
export class HidePlayerGameInfoFactory extends PlayerGameInfoFactory<HidePlayerGameInfo>
    ...
    create(): HidePlayerGameInfo {
        return new HidePlayerGameInfo(this._points, this._firstLogin, this._lastLogin, this._gamesPlayed,
            this._victories, this._deaths, this._hiderKills, this._seekerKills, this._blocks, this._bookUpgrade,
            this._rawBlockExperience, this._blockExperience, this._timeAlive, this._title, this._achievements);
    }
