import {PlayerGameInfo, PlayerGameInfoFactory, GameTypes, createDateFromResponse, Game} from "../main";
...
export class SgnPlayerGameInfoFactory extends PlayerGameInfoFactory<SgnPlayerGameInfo> {
    ...
    create(): SgnPlayerGameInfo {
        return new SgnPlayerGameInfo(this._points, this._firstLogin, this._lastLogin, this._gamesPlayed,
            this._victories, this._deaths, this._kills, this._mostPoints, this._cratesOpened, this._deathMatches,
            this._recentGames);
    }
