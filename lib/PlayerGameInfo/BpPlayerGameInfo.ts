...
export class BpPlayerGameInfo extends PlayerGameInfo
  ...
  constructor(
    ...
    readonly selectedBling: BpBling,
    readonly selectedDeathSound: BpDeathSound,
    readonly selectedTrail: BpTrail,
    readonly selectedVictorySound,
    readonly totalElimination: number,
    readonly totalPlacing: number,
    readonly unlockedBling: BpBling[],
    readonly unlockedDeathSounds: BpDeathSound[],
    readonly unlockedTrails: BpTrail[],
    readonly windDisableNarration: boolean,
...
export class BpPlayerGameInfoFactory
  extends PlayerGameInfoFactory<BpPlayerGameInfo>
  ...
  create(): BpPlayerGameInfo {
    return new BpPlayerGameInfo(
      this._points,
      this._firstLogin,
      this._victories,
      this._gamesPlayed,
      this._selectedBling,
      this._selectedDeathSound,
      this._selectedTrail,
      this._selectedVictorySound,
      this._totalElimination,
      this._totalPlacing,
      this._unlockedBling,
      this._unlockedDeathSounds,
      this._unlockedTrails,
      this._windDisableNarration,
      this._title,
      this._achievements
    );
  }
