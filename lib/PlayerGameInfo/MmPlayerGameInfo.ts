...
export class MmPlayerGameInfo extends PlayerGameInfo {
    constructor(points: number, readonly firstLogin: Date, readonly lastLogin: Date, readonly gamesPlayed: number,
                readonly victories: number, readonly title: string, readonly correctNotes: number, 
                readonly incorrectNotes: number,  readonly perfectNotes: number, readonly goodNotes: number
            ) {
        super(GameTypes.MM, points);
    }
}

export class MmPlayerGameInfoFactory extends PlayerGameInfoFactory<MmPlayerGameInfo> {
    ...
    create(): MmPlayerGameInfo {
        return new MmPlayerGameInfo(this._points, this._firstLogin, this._lastLogin, this._gamesPlayed,
            this._victories, this._title, this._correctNotes, this._incorrectNotes, this._perfectNotes,
             this._goodNotes);
    }
