...
export class BdPlayerGameInfo extends PlayerGameInfo {
    constructor(points: number, readonly firstLogin: Date, readonly lastLogin: Date, readonly gamesPlayed: number,
                readonly deaths: number, readonly kills: number, readonly title: string,
                readonly energyCollected: number, readonly batteriesCharged: number) {
        super(GameTypes.BD, points);
    }
}

export class BdPlayerGameInfoFactory extends PlayerGameInfoFactory<BdPlayerGameInfo> {
    ...
    create(): BdPlayerGameInfo {
        return new BdPlayerGameInfo(this._points, this._firstLogin, this._lastLogin, this._gamesPlayed,
            this._deaths, this._kills, this._title, this._energyCollected, this._batteriesCharged);
    }
