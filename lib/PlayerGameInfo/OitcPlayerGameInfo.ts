...
export class OitcPlayerGameInfo extends PlayerGameInfo
  ...
  constructor(
    ...
    readonly cupidUnlock: boolean,
    readonly rainbowUnlock: boolean,
    readonly musicUnlock: boolean,
    readonly herobrineUnlock: boolean,
...
export class OitcPlayerGameInfoFactory
  extends PlayerGameInfoFactory<OitcPlayerGameInfo>
