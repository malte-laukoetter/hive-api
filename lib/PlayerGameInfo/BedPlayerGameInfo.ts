...
export class BedPlayerGameInfo extends PlayerGameInfo
  ...
  constructor(
    ...
    readonly bedsDestroyed: number,
    readonly teamsEliminated,
...
export class BedPlayerGameInfoFactory
  extends PlayerGameInfoFactory<BedPlayerGameInfo>
