...
export class SpPlayerGameInfo extends PlayerGameInfo
  ...
  constructor(
    ...
    readonly eggsFired: number,
    readonly blocksDestroyed: number,
    readonly deaths: number,
    readonly timeAlive: number,
    readonly rainbowEggs: boolean,
    readonly sheepUnlock: boolean,
    readonly shovelUpgrade: boolean,
...
export class SpPlayerGameInfoFactory
  extends PlayerGameInfoFactory<SpPlayerGameInfo>
