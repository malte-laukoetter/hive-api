...
export class GravPlayerGameInfo extends PlayerGameInfo {
    constructor(points: number, readonly firstLogin: Date, readonly lastLogin: Date, readonly gamesPlayed: number,
                readonly victories: number, readonly title: string) {
        super(GameTypes.GRAV, points);
    }
}

export class GravPlayerGameInfoFactory extends PlayerGameInfoFactory<GravPlayerGameInfo> {
    ...
    create(): GravPlayerGameInfo {
        return new GravPlayerGameInfo(this._points, this._firstLogin, this._lastLogin, this._gamesPlayed,
            this._victories, this._title);
    }
