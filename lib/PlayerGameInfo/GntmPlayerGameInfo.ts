...
export class GntmPlayerGameInfoFactory extends PlayerGameInfoFactory<GntmPlayerGameInfo> {
    ...
    create(): GntmPlayerGameInfo {
        return new GntmPlayerGameInfo(this._points, this._firstLogin, this._lastLogin, this._gamesPlayed,
