...
export class SplPlayerGameInfo extends PlayerGameInfo
  ...
  constructor(
    ...
    readonly blocksPainted: number,
    readonly ultimatesEarned: number,
    readonly characterStats,
...
export class SplPlayerGameInfoFactory
  extends PlayerGameInfoFactory<SplPlayerGameInfo>
