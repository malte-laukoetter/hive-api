...
export class GntPlayerGameInfo extends PlayerGameInfo {
    constructor(points: number, readonly firstLogin: Date, readonly lastLogin: Date, readonly gamesPlayed: number,
                ...
                readonly title: string, readonly goldEarned: number, readonly beastsSlain: number,
                readonly shutdowns: number
            ) {
        super(GameTypes.GNT, points);
    }
}

export class GntPlayerGameInfoFactory extends PlayerGameInfoFactory<GntPlayerGameInfo> {
    ...
    create(): GntPlayerGameInfo {
        return new GntPlayerGameInfo(this._points, this._firstLogin, this._lastLogin, this._gamesPlayed,
            this._victories, this._deaths, this._kills, this._title, this._goldEarned, this._beastsSlain,
            this._shutdowns
        );
    }
