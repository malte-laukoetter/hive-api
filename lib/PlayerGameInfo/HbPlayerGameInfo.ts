...
export class HbPlayerGameInfo extends PlayerGameInfo
  ...
  constructor(
    ...
    readonly unlockedClasses: HbClass[],
    readonly activeClass: HbClass,
...
export class HbPlayerGameInfoFactory
  extends PlayerGameInfoFactory<HbPlayerGameInfo>
  implements PlayerGameInfoFactoryAchievements {
  private _firstLogin: Date;
  private _captures: number;
  private _kills: number;
  private _deaths: number;
  private _unlockedClasses: HbClass[] = [
    HbClass.PRIEST,
    HbClass.WIZARD,
    HbClass.SCOUT,
    HbClass.ARCHER
