...
export class CaiPlayerGameInfo extends PlayerGameInfo
  ...
  constructor(
    ...
    readonly creeperFirework: boolean,
...
export class CaiPlayerGameInfoFactory
  extends PlayerGameInfoFactory<CaiPlayerGameInfo>
