...
export class HeroPlayerGameInfo extends PlayerGameInfo
  ...
  constructor(
    ...
    readonly oneVsOnesWins: number,
    readonly deathmatches: number,
    readonly tntUsed: number,
    readonly foodConsumed: number,
    readonly cratesOpened,
...
export class HeroPlayerGameInfoFactory
  extends PlayerGameInfoFactory<HeroPlayerGameInfo>
