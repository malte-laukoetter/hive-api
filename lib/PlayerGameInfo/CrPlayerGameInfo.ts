...
export class CrPlayerGameInfo extends PlayerGameInfo
  ...
  constructor(
    ...
    readonly rccatCount: number,
    readonly rccatKills: number,
    readonly airstrikeCount: number,
    readonly airstrikeKills: number,
...
export class CrPlayerGameInfoFactory
  extends PlayerGameInfoFactory<CrPlayerGameInfo>
  ...
  create(): CrPlayerGameInfo {
    return new CrPlayerGameInfo(
      ...
      this._rccatCount,
      this._rccatKills,
      this._airstrikeCount,
      this._airstrikeKills,
      this._title,
      this._achievements
    );
  }
