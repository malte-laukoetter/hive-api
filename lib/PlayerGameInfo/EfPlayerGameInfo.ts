...
export class EfPlayerGameInfo extends PlayerGameInfo {
  constructor(
    ...
    readonly outlived: number,
    readonly blocksActivated: number
  ) {
    super(GameTypes.EF, points);
  }
}

export class EfPlayerGameInfoFactory extends PlayerGameInfoFactory<
  EfPlayerGameInfo
> {
