...
export class MimvPlayerGameInfo extends PlayerGameInfo
  ...
  constructor(
    ...
    readonly lastUsedEmote: MimvEmote,
    readonly preferredEmoteSelectorMenu: MimvEmoteSelector,
...
export class MimvPlayerGameInfoFactory
  extends PlayerGameInfoFactory<MimvPlayerGameInfo>
  ...
  create(): MimvPlayerGameInfo {
    return new MimvPlayerGameInfo(
      ...
      this._deaths,
      this._lastUsedEmote,
      this._preferredEmoteSelectorMenu,
      this._achievements,
      this._title
    );
  }
