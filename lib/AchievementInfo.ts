...
export const noLongerOptainableAchievementIds = [
  ...
  // TIMV
  "KARMA10000",
  "KARMA20000", // ??? are not in the achievement list
  ...
  // CAI
  "LEADER500",
  "LEADER1000", // "WIN1000", "WIN500" -> they would make this routine a lot more complicated so we just ignore them :P
...
export class AchievementInfo {
  constructor(
    ...
    readonly stages: number = 1,
    readonly secret: boolean = false,
    readonly custom: boolean = false,
    readonly disabled: boolean = false,
    readonly rewardType = RewardTypes.NONE,
    readonly rewardArguments: string = ""
  ) {}
 ...
 */
export class AchievementInfoFactory
  implements FromResponseFactory<AchievementInfo> {
  private _id: string = "";
