...
import {BpPlayerGameInfo, BpPlayerGameInfoFactory, SgPlayerGameInfo, SgPlayerGameInfoFactory, TimvPlayerGameInfo,
    ...
    DrPlayerGameInfo, DrPlayerGameInfoFactory, SkyPlayerGameInfo, SkyPlayerGameInfoFactory, MimvPlayerGameInfo,
...
describe("Game Info Factories", () => {
    let tests = new Set([
        ...
        [new MimvPlayerGameInfo(0, new Date(), new Date(), 0, 0, 0, 0, 0, 0, [], ""), new MimvPlayerGameInfoFactory()],
